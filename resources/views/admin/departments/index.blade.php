                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" data-href="{{ route('admin.departments.destroy', $department->id) }}" class="btn btn-danger" onclick="confirmDelete(this)">Delete</a>
                                    <form class="" action="{{ route('admin.departments.destroy', $department->id) }}" method="post" id="delete-form">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
